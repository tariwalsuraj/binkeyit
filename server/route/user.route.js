...
userRouter.post('/register',registerUserController) // post method used to send data to server
userRouter.post('/verify-email',verifyEmailController)
userRouter.post('/login',loginController)
userRouter.get('/logout',auth,logoutController)
userRouter.put('/upload-avatar',auth,upload.single('avatar'),uploadAvatar) // put method used to update data in server and multer.js
